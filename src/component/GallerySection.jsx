    ...
    <div className="bg-white h-max w-full mt-12">
      <div>
        ...
        <div className="grid grid-cols-3 gap-2 mx-4">
          ...
          >
            <img className="h-auto max-w-full " src={Gallery2 || "https://images.pexels.com/photos/8459434/pexels-photo-8459434.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"} alt="" />
          </div>
          <div
            data-aos="fade"
            data-aos-offset="200"
          ...
          <div
            ...
            data-aos-easing="ease-in-out"
          >
            <img className="h-full w-full bg-cover" src={Gallery3 || "https://images.pexels.com/photos/1308881/pexels-photo-1308881.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"} alt="" />
          </div>
        </div>
      </div>
    </div>
